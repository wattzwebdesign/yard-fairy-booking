...
class ComposerStaticInita5382a7b0dad13374e4f54f22553dcf2
{
    ...
    public static $classMap = array (
        ...
        'YFB_Ajax_Handler' => __DIR__ . '/../..' . '/includes/class-yfb-ajax-handler.php',
        'YFB_Booking_Post_Type' => __DIR__ . '/../..' . '/includes/class-yfb-booking-post-type.php',
        'YFB_Calendar_Display' => __DIR__ . '/../..' . '/includes/class-yfb-calendar-display.php',
        'YFB_Google_Calendar' => __DIR__ . '/../..' . '/includes/class-yfb-google-calendar.php',
        'YFB_Product_Booking' => __DIR__ . '/../..' . '/includes/class-yfb-product-booking.php',
        'YFB_Settings' => __DIR__ . '/../..' . '/includes/class-yfb-settings.php',
    );

    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->prefixLengthsPsr4 = ComposerStaticInita5382a7b0dad13374e4f54f22553dcf2::$prefixLengthsPsr4;
            $loader->prefixDirsPsr4 = ComposerStaticInita5382a7b0dad13374e4f54f22553dcf2::$prefixDirsPsr4;
            $loader->classMap = ComposerStaticInita5382a7b0dad13374e4f54f22553dcf2::$classMap;
